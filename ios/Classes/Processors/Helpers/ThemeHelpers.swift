...
class ThemeHelpers {
    ...
    public class func setAppTheme(theme: String,registrar:FlutterPluginRegistrar?) {
        Config.currentCustomization = getCustomizationForTheme(theme: theme,registrar:registrar)
        Config.currentLowLightCustomization = getLowLightCustomizationForTheme(theme: theme,registrar:registrar)
        Config.currentDynamicDimmingCustomization = getDynamicDimmingCustomizationForTheme(theme: theme,registrar:registrar)
    ...
    class func getCustomizationForTheme(theme: String,registrar:FlutterPluginRegistrar?) -> FaceTecCustomization {
        var currentCustomization = FaceTecCustomization()
        let key = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_1.png")
        print(key)
        let path = Bundle.main.path(forResource: key, ofType: nil)!
        let key1 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_2.png")
        let path1 = Bundle.main.path(forResource: key1, ofType: nil)!
        let key2 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_3.png")
        let path2 = Bundle.main.path(forResource: key2, ofType: nil)!
        let key3 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_4.png")
        let path3 = Bundle.main.path(forResource: key3, ofType: nil)!
        let key4 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_5.png")
        let path4 = Bundle.main.path(forResource: key4, ofType: nil)!
        let retryScreenSlideshowImages = [UIImage(contentsOfFile: path)!,UIImage(contentsOfFile: path1)!,UIImage(contentsOfFile: path2)!,UIImage(contentsOfFile: path3)!,UIImage(contentsOfFile: path4)!]
        //let retryScreenSlideshowImages = [UIImage(contentsOfFile: path)!, UIImage(named: "FaceTec_ideal_2")!, UIImage(named: "FaceTec_ideal_3")!, UIImage(named: "FaceTec_ideal_4")!, UIImage(named: "FaceTec_ideal_5")!]
        ...
        if theme == "FaceTec Theme" {
            ...
            let camera_shutter_black_key = registrar?.lookupKey(forAsset: "assets/images/themes/pseudo-fullscreen/camera_shutter_black.png")
            let camera_shutter_black_path = Bundle.main.path(forResource: camera_shutter_black_key, ofType: nil)!
            currentCustomization.guidanceCustomization.cameraPermissionsScreenImage = UIImage(contentsOfFile: camera_shutter_black_path)
            // ID Scan Customization
            currentCustomization.idScanCustomization.showSelectionScreenDocumentImage = true
            let document_black_key = registrar?.lookupKey(forAsset: "assets/images/themes/pseudo-fullscreen/document_black.png")
            let document_black_path = Bundle.main.path(forResource: document_black_key, ofType: nil)!
            currentCustomization.idScanCustomization.selectionScreenDocumentImage = UIImage(contentsOfFile: document_black_path)
            ...
            let faceTec_active_torch_key = registrar?.lookupKey(forAsset: "assets/images/themes/FaceTec_active_torch.png")
            let faceTec_active_torch_path = Bundle.main.path(forResource: faceTec_active_torch_key, ofType: nil)!
            currentCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: faceTec_active_torch_path)
            let faceTec_inactive_torch_key = registrar?.lookupKey(forAsset: "assets/images/themes/FaceTec_inactive_torch.png")
            let faceTec_inactive_torch_path = Bundle.main.path(forResource: faceTec_inactive_torch_key, ofType: nil)!
            currentCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: faceTec_inactive_torch_path)
            ...
            let single_chevron_left_black_key = registrar?.lookupKey(forAsset: "assets/images/themes/pseudo-fullscreen/single_chevron_left_black.png")
            let single_chevron_left_black_path = Bundle.main.path(forResource: single_chevron_left_black_key, ofType: nil)!
            currentCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: single_chevron_left_black_path)
            ...
            currentCustomization.guidanceCustomization.enableRetryScreenSlideshowShuffle = true
            let camera_green_key = registrar?.lookupKey(forAsset: "assets/images/themes/well-rounded/camera_green.png")
            let camera_green_path = Bundle.main.path(forResource: camera_green_key, ofType: nil)!
            currentCustomization.guidanceCustomization.cameraPermissionsScreenImage = UIImage(contentsOfFile: camera_green_path)
            // ID Scan Customization
            currentCustomization.idScanCustomization.showSelectionScreenDocumentImage = true
            let document_green_key = registrar?.lookupKey(forAsset: "assets/images/themes/well-rounded/document_green.png")
            let document_green_path = Bundle.main.path(forResource: document_green_key, ofType: nil)!
            currentCustomization.idScanCustomization.selectionScreenDocumentImage = UIImage(contentsOfFile: document_green_path)
            currentCustomization.idScanCustomization.showSelectionScreenBrandingImage = false
            currentCustomization.idScanCustomization.selectionScreenBrandingImage = nil
            currentCustomization.idScanCustomization.selectionScreenBackgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.idScanCustomization.reviewScreenBackgroundColors = [backgroundColor, backgroundColor]
            ...
            // Cancel Button Customization
            let cancel_round_green_key = registrar?.lookupKey(forAsset: "assets/images/themes/well-rounded/cancel_round_green.png")
            let cancel_round_green_path = Bundle.main.path(forResource: cancel_round_green_key, ofType: nil)!
            currentCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: cancel_round_green_path)
            ...
            let bitcoin_exchange_logo_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/bitcoin_exchange_logo.png")
            let bitcoin_exchange_logo_path = Bundle.main.path(forResource: bitcoin_exchange_logo_key, ofType: nil)!
            currentCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: bitcoin_exchange_logo_path)
            // Guidance Customization
            currentCustomization.guidanceCustomization.backgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.guidanceCustomization.foregroundColor = primaryColor
            currentCustomization.guidanceCustomization.headerFont = headerFont
            ...
            currentCustomization.guidanceCustomization.retryScreenSlideshowInterval = 1500
            currentCustomization.guidanceCustomization.enableRetryScreenSlideshowShuffle = true
            let camera_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/camera_orange.png")
            let camera_orange_path = Bundle.main.path(forResource: camera_orange_key, ofType: nil)!
            currentCustomization.guidanceCustomization.cameraPermissionsScreenImage = UIImage(contentsOfFile: camera_orange_path)
            // ID Scan Customization
            currentCustomization.idScanCustomization.showSelectionScreenDocumentImage = true
            let document_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/document_orange.png")
            let document_orange_path = Bundle.main.path(forResource: document_orange_key, ofType: nil)!
            currentCustomization.idScanCustomization.selectionScreenDocumentImage = UIImage(contentsOfFile: document_orange_path)
            currentCustomization.idScanCustomization.showSelectionScreenBrandingImage = false
            currentCustomization.idScanCustomization.selectionScreenBrandingImage = nil
            currentCustomization.idScanCustomization.selectionScreenBackgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.idScanCustomization.reviewScreenBackgroundColors = [backgroundColor, backgroundColor]
            ...
            currentCustomization.idScanCustomization.captureFrameStrokeWith = 2
            currentCustomization.idScanCustomization.captureFrameCornerRadius = 12
            let torch_active_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/torch_active_orange.png")
            let torch_active_orange_path = Bundle.main.path(forResource: torch_active_orange_key, ofType: nil)!
            currentCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: torch_active_orange_path)
            let torch_inactive_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/torch_inactive_orange.png")
            let torch_inactive_orange_path = Bundle.main.path(forResource: torch_inactive_orange_key, ofType: nil)!
            currentCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: torch_inactive_orange_path)
            // OCR Confirmation Screen Customization
            currentCustomization.ocrConfirmationCustomization.backgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.ocrConfirmationCustomization.mainHeaderDividerLineColor = secondaryColor
            ...
            currentCustomization.resultScreenCustomization.activityIndicatorColor = primaryColor
            let activity_indicator_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/activity_indicator_orange.png")
            let activity_indicator_orange_path = Bundle.main.path(forResource: activity_indicator_orange_key, ofType: nil)!
            currentCustomization.resultScreenCustomization.customActivityIndicatorImage = UIImage(contentsOfFile: activity_indicator_orange_path)
            ...
            // Cancel Button Customization
            let single_chevron_left_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/single_chevron_left_orange.png")
            let single_chevron_left_orange_path = Bundle.main.path(forResource: single_chevron_left_orange_key, ofType: nil)!
            currentCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: single_chevron_left_orange_path)
            currentCustomization.cancelButtonCustomization.location = FaceTecCancelButtonLocation.topLeft
            ...
            currentCustomization.overlayCustomization.backgroundColor = UIColor.clear
            currentCustomization.overlayCustomization.showBrandingImage = true
            let ekyc_logo_key = registrar?.lookupKey(forAsset: "assets/images/themes/ekyc/ekyc_logo.png")
            let ekyc_logo_path = Bundle.main.path(forResource: ekyc_logo_key, ofType: nil)!
            currentCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: ekyc_logo_path)
            // Guidance Customization
            currentCustomization.guidanceCustomization.backgroundColors = [backgroundColor, backgroundColor]
            ...
            currentCustomization.guidanceCustomization.retryScreenSlideshowInterval = 1500
            currentCustomization.guidanceCustomization.enableRetryScreenSlideshowShuffle = true
            let camera_red_key = registrar?.lookupKey(forAsset: "assets/images/themes/ekyc/camera_red.png")
            let camera_red_path = Bundle.main.path(forResource: camera_red_key, ofType: nil)!
            currentCustomization.guidanceCustomization.cameraPermissionsScreenImage = UIImage(contentsOfFile: camera_red_path)
            // ID Scan Customization
            ...
            // Cancel Button Customization
            let cancel_box_red_key = registrar?.lookupKey(forAsset: "assets/images/themes/ekyc/cancel_box_red.png")
            let cancel_box_red_path = Bundle.main.path(forResource: cancel_box_red_key, ofType: nil)!
            currentCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: cancel_box_red_path)
            ...
            currentCustomization.overlayCustomization.backgroundColor = UIColor.clear
            currentCustomization.overlayCustomization.showBrandingImage = true
            let sample_bank_logo_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/sample_bank_logo.png")
            let sample_bank_logo_path = Bundle.main.path(forResource: sample_bank_logo_key, ofType: nil)!
            currentCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: sample_bank_logo_path)
            // Guidance Customization
            currentCustomization.guidanceCustomization.backgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.guidanceCustomization.foregroundColor = primaryColor
            currentCustomization.guidanceCustomization.headerFont = headerFont
            ...
            let camera_white_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/camera_white_navy.png")
            let camera_white_navy_path = Bundle.main.path(forResource: camera_white_navy_key, ofType: nil)!
            currentCustomization.guidanceCustomization.cameraPermissionsScreenImage = UIImage(contentsOfFile: camera_white_navy_path)
            // ID Scan Customization
            currentCustomization.idScanCustomization.showSelectionScreenDocumentImage = false
            currentCustomization.idScanCustomization.selectionScreenDocumentImage = nil
            currentCustomization.idScanCustomization.showSelectionScreenBrandingImage = false
            ...
            currentCustomization.idScanCustomization.captureFrameStrokeWith = 2
            currentCustomization.idScanCustomization.captureFrameCornerRadius = 12
            let torch_active_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/torch_active_white.png")
            let torch_active_white_path = Bundle.main.path(forResource: torch_active_white_key, ofType: nil)!
            currentCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: torch_active_white_path)
            let torch_inactive_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/torch_inactive_white.png")
            let torch_inactive_white_path = Bundle.main.path(forResource: torch_inactive_white_key, ofType: nil)!
            currentCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: torch_inactive_white_path)
            // OCR Confirmation Screen Customization
            currentCustomization.ocrConfirmationCustomization.backgroundColors = [backgroundColor, backgroundColor]
            currentCustomization.ocrConfirmationCustomization.mainHeaderDividerLineColor = primaryColor
            currentCustomization.ocrConfirmationCustomization.mainHeaderDividerLineWidth = 2
            ...
            currentCustomization.resultScreenCustomization.messageFont = headerFont
            currentCustomization.resultScreenCustomization.activityIndicatorColor = primaryColor
            let activity_indicator_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/activity_indicator_white.png")
            let activity_indicator_white_path = Bundle.main.path(forResource: activity_indicator_white_key, ofType: nil)!
            currentCustomization.resultScreenCustomization.customActivityIndicatorImage = UIImage(contentsOfFile: activity_indicator_white_path)
            currentCustomization.resultScreenCustomization.customActivityIndicatorRotationInterval = 1000
            currentCustomization.resultScreenCustomization.resultAnimationBackgroundColor = UIColor.clear
            currentCustomization.resultScreenCustomization.resultAnimationForegroundColor = primaryColor
            let reticle_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/reticle_white.png")
            let reticle_white_path = Bundle.main.path(forResource: reticle_white_key, ofType: nil)!
            currentCustomization.resultScreenCustomization.resultAnimationSuccessBackgroundImage = UIImage(contentsOfFile: reticle_white_path)

            currentCustomization.resultScreenCustomization.resultAnimationUnsuccessBackgroundImage = UIImage(contentsOfFile: reticle_white_path)
            currentCustomization.resultScreenCustomization.showUploadProgressBar = true
            ...
            currentCustomization.ovalCustomization.progressColor2 = primaryColor.withAlphaComponent(0.5)
            // Cancel Button Customization
            let cancel_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/cancel_white.png")
            let cancel_white_path = Bundle.main.path(forResource: cancel_white_key, ofType: nil)!
            currentCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: cancel_white_path)
            currentCustomization.cancelButtonCustomization.location = FaceTecCancelButtonLocation.topLeft
        }
    ...
    class func getLowLightCustomizationForTheme(theme: String,registrar:FlutterPluginRegistrar?) -> FaceTecCustomization {
        var currentLowLightCustomization: FaceTecCustomization = getCustomizationForTheme(theme: theme,registrar:registrar)
        let key = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_1.png")
                let path = Bundle.main.path(forResource: key, ofType: nil)!
                let key1 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_2.png")
                let path1 = Bundle.main.path(forResource: key1, ofType: nil)!
        ...
        if theme == "Config Wizard Theme" {
            ...
            let bitcoin_exchange_logo_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/bitcoin_exchange_logo.png")
            let bitcoin_exchange_logo_path = Bundle.main.path(forResource: bitcoin_exchange_logo_key, ofType: nil)!
            currentLowLightCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: bitcoin_exchange_logo_path)
            // Guidance Customization
            ...
            // ID Scan Customization
            let document_grey_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/document_grey.png")
            let document_grey_path = Bundle.main.path(forResource: document_grey_key, ofType: nil)!
            currentLowLightCustomization.idScanCustomization.selectionScreenDocumentImage = UIImage(contentsOfFile: document_grey_path)
            ...
            let torch_active_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/torch_active_orange.png")
            let torch_active_orange_path = Bundle.main.path(forResource: torch_active_orange_key, ofType: nil)!
            currentLowLightCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: torch_active_orange_path)
            let torch_inactive_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/torch_inactive_orange.png")
            let torch_inactive_orange_path = Bundle.main.path(forResource: torch_inactive_orange_key, ofType: nil)!
            currentLowLightCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: torch_inactive_orange_path)
            // Result Screen Customization
            ...
            let activity_indicator_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/activity_indicator_orange.png")
            let activity_indicator_orange_path = Bundle.main.path(forResource: activity_indicator_orange_key, ofType: nil)!
            currentLowLightCustomization.resultScreenCustomization.customActivityIndicatorImage = UIImage(contentsOfFile: activity_indicator_orange_path)
            ...
            let single_chevron_left_orange_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/single_chevron_left_orange.png")
            let single_chevron_left_orange_path = Bundle.main.path(forResource: single_chevron_left_orange_key, ofType: nil)!
            currentLowLightCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: single_chevron_left_orange_path)
            ...
            let sample_bank_logo_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/sample_bank_logo.png")
            let sample_bank_logo_path = Bundle.main.path(forResource: sample_bank_logo_key, ofType: nil)!
            currentLowLightCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: sample_bank_logo_path)
            // Guidance Customization
            currentLowLightCustomization.guidanceCustomization.foregroundColor = backgroundColor
            ...
            currentLowLightCustomization.idScanCustomization.captureFrameStrokeColor = primaryColor
            let torch_active_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/torch_active_navy.png")
            let torch_active_navy_path = Bundle.main.path(forResource: torch_active_navy_key, ofType: nil)!
            currentLowLightCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: torch_active_navy_path)
            let torch_inactive_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/torch_inactive_navy.png")
            let torch_inactive_navy_path = Bundle.main.path(forResource: torch_inactive_navy_key, ofType: nil)!
            currentLowLightCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: torch_inactive_navy_path)
            // OCR Confirmation Screen Customization
            ...
            let activity_indicator_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/activity_indicator_navy.png")
            let activity_indicator_navy_path = Bundle.main.path(forResource: activity_indicator_navy_key, ofType: nil)!
            currentLowLightCustomization.resultScreenCustomization.customActivityIndicatorImage = UIImage(contentsOfFile: activity_indicator_navy_path)
            ...
            let reticle_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/reticle_navy.png")
            let reticle_navy_path = Bundle.main.path(forResource: reticle_navy_key, ofType: nil)!
            currentLowLightCustomization.resultScreenCustomization.resultAnimationSuccessBackgroundImage = UIImage(contentsOfFile: reticle_navy_path)

            currentLowLightCustomization.resultScreenCustomization.resultAnimationUnsuccessBackgroundImage = UIImage(contentsOfFile: reticle_navy_path)
            currentLowLightCustomization.resultScreenCustomization.uploadProgressTrackColor = UIColor.black.withAlphaComponent(0.2)
            ...
            // Cancel Button Customization
            let cancel_navy_key = registrar?.lookupKey(forAsset: "assets/images/themes/sample-bank/cancel_navy.png")
            let cancel_navy_path = Bundle.main.path(forResource: cancel_navy_key, ofType: nil)!
            currentLowLightCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: cancel_navy_path)
        }
    ...
    // Configure UX Color Scheme For Low Light Mode
    class func getDynamicDimmingCustomizationForTheme(theme: String,registrar:FlutterPluginRegistrar?) -> FaceTecCustomization {
        var currentDynamicDimmingCustomization: FaceTecCustomization = getCustomizationForTheme(theme: theme,registrar:registrar)
        let key = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_1.png")
                let path = Bundle.main.path(forResource: key, ofType: nil)!
                let key1 = registrar?.lookupKey(forAsset: "assets/images/FaceTec_ideal_2.png")
                let path1 = Bundle.main.path(forResource: key1, ofType: nil)!
        ...
        if theme == "FaceTec Theme" {
            ...
            // ID Scan Customization
            let document_offwhite_key = registrar?.lookupKey(forAsset: "assets/images/themes/pseudo-fullscreen/document_offwhite.png")
            let document_offwhite_path = Bundle.main.path(forResource: document_offwhite_key, ofType: nil)!
            currentDynamicDimmingCustomization.idScanCustomization.selectionScreenDocumentImage = UIImage(contentsOfFile: document_offwhite_path)
            ...
            let torch_active_offwhite_key = registrar?.lookupKey(forAsset: "assets/images/themes/torch_active_offwhite.png")
            let torch_active_offwhite_path = Bundle.main.path(forResource: torch_active_offwhite_key, ofType: nil)!
            currentDynamicDimmingCustomization.idScanCustomization.activeTorchButtonImage = UIImage(contentsOfFile: torch_active_offwhite_path)
            let torch_inactive_offwhite_key = registrar?.lookupKey(forAsset: "assets/images/themes/torch_inactive_offwhite.png")
            let torch_inactive_offwhite_path = Bundle.main.path(forResource: torch_inactive_offwhite_key, ofType: nil)!
            currentDynamicDimmingCustomization.idScanCustomization.inactiveTorchButtonImage = UIImage(contentsOfFile: torch_inactive_offwhite_path)
            // OCR Confirmation Screen Customization
            ...
            // Cancel Button Customization
            let single_chevron_left_offwhite_key = registrar?.lookupKey(forAsset: "assets/images/themes/pseudo-fullscreen/single_chevron_left_offwhite.png")
            let single_chevron_left_offwhite_path = Bundle.main.path(forResource: single_chevron_left_offwhite_key, ofType: nil)!
            currentDynamicDimmingCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: single_chevron_left_offwhite_path)
            ...
            // Overlay Customization
            let bitcoin_exchange_logo_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/bitcoin-exchange/bitcoin_exchange_logo_white.png")
            let bitcoin_exchange_logo_white_path = Bundle.main.path(forResource: bitcoin_exchange_logo_white_key, ofType: nil)!
            currentDynamicDimmingCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: bitcoin_exchange_logo_white_path)
        }
        else if theme == "eKYC" {
            let primaryColor = UIColor(red: 0.929, green: 0.110, blue: 0.141, alpha: 1) // red
            ...
            // Overlay Customization
            let ekyc_logo_white_key = registrar?.lookupKey(forAsset: "assets/images/themes/ekyc/ekyc_logo_white.png")
            let ekyc_logo_white_path = Bundle.main.path(forResource: ekyc_logo_white_key, ofType: nil)!
            currentDynamicDimmingCustomization.overlayCustomization.brandingImage = UIImage(contentsOfFile: ekyc_logo_white_path)
            // Guidance Customization
            ...
            let cancel_box_red_key = registrar?.lookupKey(forAsset: "assets/images/themes/ekyc/cancel_box_red.png")
            let cancel_box_red_path = Bundle.main.path(forResource: cancel_box_red_key, ofType: nil)!
            currentDynamicDimmingCustomization.cancelButtonCustomization.customImage = UIImage(contentsOfFile: cancel_box_red_path)
        }
